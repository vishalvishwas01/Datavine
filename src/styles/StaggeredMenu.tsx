    ...
    >
      ...
      >
        ...
        <aside
          ...
          aria-hidden={!open}
        >
          <div className="text-2xl pb-2 block sm:hidden">{session?.user?.name || ""}</div>
          ...
          <button
            ...
            className="text-[4em] font-semibold uppercase text-gray-500 hover:text-gray-300 transition-all cursor-pointer w-full justify-start items-start text-start"
          >
            Log Out
          </button>
        </aside>
