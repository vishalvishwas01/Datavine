...
const Form3 = () => {
  ...
  const [fieldsForm4, setFieldsForm4] = useState<Field[]>([]);
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setPublicLink(`${window.location.origin}/forms/share/form3`);
    }
  }, []);
  ...
  useEffect(() => {
    localStorage.setItem(`form-form3`, JSON.stringify(fields));
  }, [fields]);
